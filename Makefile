...
LDFLAGS=-ldflags "-X github.com/ahmabora1/rcm/internal/cmd.Version=$(VERSION) -X github.com/ahmabora1/rcm/internal/cmd.Commit=$(COMMIT) -X github.com/ahmabora1/rcm/internal/cmd.BuildDate=$(BUILD_DATE)"
